...
void ASanityDrainVolume::Tick(float DeltaTime)
{
	...
	{
		ActiveSanityComponent->ModifySanity(-DrainRatePerSecond * DeltaTime, FGameplayTag());
	}
}

void ASanityDrainVolume::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (OtherActor)
	{
...
void ASanityDrainVolume::OnOverlapEnd(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
